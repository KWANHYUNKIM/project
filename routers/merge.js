...
const bucketName = 'test105-wikipedia-store';
    ...
    axios.all([twitterRequest,weatherRequest,YoutubeRequest]) //weatherRequest
        .then(
            axios.spread((...responses) => {
                ...
                res.render('/Users/kwanhyunkim/Desktop/assignment/views/result.pug', { ///Users/kwanhyunkim/Desktop/assignment/views/result.pug
                    twitter: responseOne,
                    weather: responseTwo,
